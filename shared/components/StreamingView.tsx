  ...
  return (
    <div className={`flex min-h-0 flex-col gap-2 ${className}`}>
      ...
      <div
        ...
        className="relative min-h-[124px] flex-1 overflow-y-auto rounded-xl border border-slate-200/70 bg-white/50 px-3 py-2.5 text-sm leading-[1.75] text-slate-800 transition-all runbi-scrollbar dark:border-white/[0.07] dark:bg-black/15 dark:text-slate-100"
      >
        {error ? (
          <div className="flex h-full min-h-[98px] flex-col items-center justify-center gap-2 text-center">
          ...
          <div className="flex h-full min-h-[98px] items-center justify-center gap-2 text-xs text-slate-400 dark:text-slate-400">
          ...
          <div className="flex h-full min-h-[98px] flex-col items-center justify-center text-center">
            <div className="mb-2 flex h-9 w-9 items-center justify-center rounded-xl border border-teal-400/20 bg-teal-400/10 text-teal-400">
            ...
            <p className="mt-1 text-[11px] text-slate-400 dark:text-slate-500">选择润色方式，或在下方补充具体要求</p>
          </div>
        ) : (
          <div className="whitespace-pre-wrap break-words font-sans select-text">
            {content}
            {isGenerating && (
      ...
      <div className="flex items-center justify-between px-1 text-[11px] text-slate-400 select-none dark:text-slate-400">
